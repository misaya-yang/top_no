# PR-2b Calibrated Method Registry Implementation Plan

- [x] Add failing tests for registry completeness/status and fail-closed lookup.
- [x] Add failing tests for global margin, signed C-nu, and APS calibration.
